...
\begin{enumerate}
\item Soient $\varphi, \psi \in L^2(\mu)$, et écrivons
$$
...
\item C'est le théorème de Birkhoff appliqué à $\textbf{1}_C \in L^1(\mu)$.
\item On applique l'\textbf{Exercice 2} du TD 10 : $R_\alpha$ est une isométrie et $\mu(U) > 0$ pour tout ouvert non vide $U$, donc $S_n\varphi$ converge uniformément vers une fonction continue $\psi$.  Comme $R_\alpha$ est ergodique pour $\mu$, alors $\psi$ est constante égale à $\int_{\T^d} \varphi \dd \mu.$
...
\begin{enumerate}
\item On applique le théorème de Kac :
$$
...
$$
ce qui conclut.  
\item C'est direct par la question précédente.
...
$$
la convergence \'etant presque s¬ûre, mais aussi ayant lieu dans $L^2(\T^d)$.
\end{enumerate}
