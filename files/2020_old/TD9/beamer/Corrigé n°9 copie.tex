...
{Exercice 2}
Soit $(U_i)_{i \in \N}$ une base dénombrable d'ouverts.  

Soit $i \in \N$ ; par le théorème de récurrence de Poincaré, il existe $V_i \subset U_i$ avec $\mu(U_i \setminus V_i) = 0$  tel que
$$
...
On se ramène au cas $\R^n$ avec une partition de l'unité. On note $\phi_t$ le flot de $X$. Soit $\varphi \in C^\infty_c(\R^n)$.  On a, si $\lambda$ est la mesure de Lebesgue,
$$
\begin{aligned}
